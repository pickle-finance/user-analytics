import type { FetchResult, Observable, ObservableQuery, ApolloError } from "@apollo/client/core";
...
export type WritableQuery<TData> = WritableResult<TData> &
    ObservableQueryExtensions<TData>;

export function observableQueryToWritable<
    TData = unknown,
    TVariables = unknown
>(
    ...
    const store = observableToWritable(query, initialValue) as WritableQuery<
        TData
    >;
